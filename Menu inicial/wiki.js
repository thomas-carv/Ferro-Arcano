(() => {
  ...
  const chapters = [
    ...
    { id: 'combat', number: '02', title: 'Combate e Equipamento', lead: 'Regras de engajamento, armas de fogo, posicionamento e condições de sobrevivência.', blocks: [
      ['Resolução de Ataques', 'A precisão e a letalidade dependem do tipo de engajamento:<br><br>• <strong>Armas de Fogo (Distância):</strong><br>VA (Valor de Ataque) = 10 + FOC + bônus da arma + modificadores.<br>• <strong>Corpo a Corpo (Físico):</strong><br>VA = 10 + FOR + Briga/Corpo a Corpo + bônus da arma + modificadores.<br><br><i>Nota: Pontaria foi totalmente removida das fórmulas de ataque do sistema.</i>'],
