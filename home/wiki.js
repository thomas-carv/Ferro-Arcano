(() => {
  ...
  const classMechanics = {
    ...
    'Ciborgue': [
      { name: 'Visão de Sistema', program: 'Custo: 1 PP. Recebe +2 em testes de Percepção / Prontidão e deixa o alvo como Marcado por 3 rodadas.', sobrecarga: '<strong>Scanner Tático:</strong> Revela fraquezas estruturais ocultas do alvo, garantindo +1 na margem de crítico contra ele.' },
